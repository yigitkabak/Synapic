...
exports.fetchOpenRouterResponse = void 0;
...
const fetchOpenRouterResponse = async (query) => {
    for (const model of MODELS) {
        try {
            console.log(`The model is being tested: ${model}`);
